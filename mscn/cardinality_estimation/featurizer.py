...
class Featurizer():
    def __init__(self, **kwargs):
        ...
        # 新添加的：是否使用join sampling/single table sampling的embedding结果
    ...
    def update_seen_preds(self, qreps):
        ...
        for qrep in qreps:
            ...
            for node, info in qrep["join_graph"].nodes(data=True):
                ...
                if not self.use_single_table_sample_embedding:
    ...
    def setup(self,
            ...
            featkey=None,
            use_join_sample_embedding=True,
            use_single_table_sample_embedding=True,
    ...
    def init_feature_mapping(self):
        ...
        if self.sample_bitmap:
            ...
            if self.featurization_type == "set":
                if self.use_single_table_sample_embedding:
                    # TODO: self.embedding_dim赋值
