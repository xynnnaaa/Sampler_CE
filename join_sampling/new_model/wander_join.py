...
class WanderJoinEngine:
    ...
    def extend_paths_one_step(self, active_paths, step_info, pid_map_full, global_map_full, workload_name=""):
        ...
        # 批量获取并翻译 Bitmap
        translated_map, _ = self._batch_fetch_translate_bitmaps(
            real_name, pending_bitmap_ids, workload_name=workload_name, 
            alias=alias, pid_map=my_pid_map, global_map=my_global_mask
        )
